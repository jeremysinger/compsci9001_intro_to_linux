...
Today, we are going to introduce the \LaTeX\  system for document processing. This is pre-installed on the Glasgow Linux system \texttt{stlinux09}. However if you are running your own Linux distro, you might want to install the software for yourself.
On Ubuntu, try
